...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className={`fixed top-0 left-0 w-full z-[100] transition-all duration-500 ${
      scrolled ? 'bg-white/95 dark:bg-[#0f0f0f]/95 backdrop-blur-md h-20 shadow-lg shadow-black/5 dark:shadow-none border-b border-gray-200 dark:border-gray-800' : 'bg-transparent h-28 border-b border-transparent'
    }`}>
        ...
        <div className="flex justify-between items-center h-full">
          ...
          <div className="hidden md:flex items-center gap-12">
            {navLinks.map((link) => (
              ...
              >
                <span className={location.pathname === link.path ? 'text-[#e10600]' : 'text-black dark:text-gray-200 group-hover:text-[#e10600]'}>
                  {link.name}
                </span>
                <span 
            ...
            <ThemeToggle className="ml-4 text-black dark:text-gray-200" />
            <a href="https://discord.gg/2xKx4NcwRm" target="_blank" rel="noreferrer" className="px-4 py-2 bg-black dark:bg-white dark:text-black text-white hover:bg-[#e10600] dark:hover:bg-[#e10600] dark:hover:text-white transition-all hover:-translate-y-0.5 hover:shadow-[0_4px_12px_rgba(225,6,0,0.3)] shadow-[4px_4px_0px_rgba(225,6,0,0.3)] flex items-center justify-center">
          ...
          {/* Mobile Menu Button */}
          <div className="md:hidden z-[1000] relative flex items-center gap-2">
            <ThemeToggle className="text-black dark:text-gray-200" />
            <button
